...
if (!DASHBOARD_URL) {
  console.error(
    ...
    'Example: VITE_DASHBOARD_URL=https://dbs.verihealths.com (production)'
  );
}
      ...
      <div className="min-h-screen flex items-center justify-center bg-red-50 p-4">
        <div className="max-w-md bg-white rounded-lg shadow-lg p-6 border-2 border-red-500">
          ...
          <p className="text-sm text-gray-600 mt-2">
            <strong>Production:</strong> <code className="bg-gray-100 px-1 py-0.5 rounded text-xs">VITE_DASHBOARD_URL=https://dbs.verihealths.com</code>
          </p>
        </div>
      </div>
    );
